...
public class SoapWebServiceConfig extends WsConfigurerAdapter {
    ...
    @Bean
    public ServletRegistrationBean<MessageDispatcherServlet> messageDispatcherServlet(ApplicationContext cx) {
        MessageDispatcherServlet servlet = new MessageDispatcherServlet();
        servlet.setApplicationContext(cx);
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema usuariosSchema) {
        ...
        wsdl.setTargetNamespace("http://demo.com/soap/usuarios");
